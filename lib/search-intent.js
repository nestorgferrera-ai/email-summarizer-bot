...
- "query": solo el contenido real a buscar (nombres, palabras clave), SIN incluir palabras de relleno como "últimos", "recientes", "correos", "mensajes", "emails", "buscar", "de", "asunto", "que mencione(n)", "sobre", cantidades en número o en palabras, rangos de tiempo, menciones a "sin leer"/"no leídos", ni artículos sueltos.
...
- "unread": true SOLO si el usuario pide explícitamente correos "sin leer", "no leídos", "sin abrir" o "unread". En cualquier otro caso, false.
- Si la instrucción no tiene contenido de búsqueda real (solo pide "los últimos N correos", un rango de tiempo, o solo "sin leer", sin remitente/asunto/tema), usa field "text" y query "" (cadena vacía).`;
